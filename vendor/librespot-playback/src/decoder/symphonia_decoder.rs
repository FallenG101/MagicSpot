...
// Symphonia requires a power-of-two ring larger than its 32 KiB maximum read
// block. Keep this independent from librespot's network request granularity.
const SYMPHONIA_BUFFER_LEN: usize = 64 * 1024;
...
impl SymphoniaDecoder {
        ...
        R: MediaSource + 'static,
    {
        let mss_opts = MediaSourceStreamOptions {
            buffer_len: SYMPHONIA_BUFFER_LEN,
        };
